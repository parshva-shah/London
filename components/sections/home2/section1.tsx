						...
						<div className="row">
							<div className="col-lg-6">
								<div className="hero2-header">
									...
									<h1><span className="conferences">Conferences</span> “ <CountUp className="odometer"  end={25} /> ”</h1>
									<Countdown />
									<div className="space32" />
									<div className="btn-area1">
										<Link href="/schedule" className="vl-btn2"><span className="demo">Reserve My Seat</span><span className="arrow"><i className="fa-solid fa-arrow-right" /></span></Link>
									</div>
								</div>
							</div>
