							...
							<div className="about-header heading13">
								...
								<div className="counter-area" data-aos="fade-left" data-aos-duration={1000}>
									<div className="counter-box">
										<h3><CountUp className="odometer"  end={250} />+</h3>
										<div className="space18" />
										<p>Our Journalist</p>
									</div>
									<div className="counter-box">
										<h3><CountUp className="odometer"  end={15} />+</h3>
										<div className="space18" />
										<p>Our Speaker</p>
									</div>
									<div className="counter-box" style={{ border: 'none' }}>
										<h3><CountUp className="odometer"  end={7} />K+</h3>
										<div className="space18" />
										<p>Attendees</p>
									</div>
								</div>
								...
								<div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
									<Link href="/schedule" className="vl-btn10">About Form <img src="/assets/img/icons/arrow2.svg" alt="" /></Link>
								</div>
							</div>
						</div>
					</div>
